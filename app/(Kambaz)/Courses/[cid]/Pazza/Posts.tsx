...
export default function Posts({ setNewPost, setCurrentPost, currentPost, posts }: { setNewPost: (value: boolean) => void, setCurrentPost: (post: any) => void, currentPost: any, posts: any[] }) {
